...
export default function PokemonCard({ pokemon, isFavorite, toggleFavorite }) {
  ...
  return (
    <>
      <div
        className="bg-neutral-200 rounded-lg shadow-md p-4 cursor-pointer hover:shadow-lg transition-shadow duration-300 transform hover:scale-105"
      ...
      >
        ...
        <button
          className={`mt-4 w-full py-2 px-4 rounded-full flex items-center justify-center ${
        ...
        >
          <Heart className={`w-5 h-5 ${isFavorite ? 'fill-current' : ''} mr-2`} />
